export const zhOnboardingProviders = {
  ...
  drawer: {
    ...
    network: {
      ...
      pillCustom: '自定义',
      pillDirect: '直连',
      pillUnsupported: '检测到 SOCKS · 未生效',
      hintSystem: '已探测到 {{url}} · 来自{{source}}',
      hintSystemNone: '没探测到系统代理，当前直连。境外服务商和免费图床可能连不上。',
      hintCustom: '只对 Nomi 生效，不改你的系统代理。支持 http:// 与 https://',
      hintOff: '所有请求直连。境外服务商与免费图床可能连不上，本机参考图会送不出去。',
      hintUnsupported: '本版只支持 HTTP 代理。请在代理软件里改用 HTTP 端口，或在这里填「自定义」地址。',
      sourceEnv: '环境变量',
      sourceSystem: '系统设置',
      sourceCustom: '你的设置',
...
export const enOnboardingProviders = {
  ...
  drawer: {
    ...
    network: {
      ...
      pillCustom: 'Custom',
      pillDirect: 'Direct',
      pillUnsupported: 'SOCKS detected · not active',
      ...
      hintCustom: 'Applies to Nomi only; your system proxy is untouched. http:// and https:// are supported.',
      ...
      hintUnsupported: 'This build supports HTTP proxies only. Switch your proxy app to its HTTP port, or enter a custom address here.',
