...
const zhCN = {
  ...
  paths: {
    ...
    teams: {
      kicker: '02 / FOR TEAMS',
      title: '让 Nomi 适配你的业务',
      description: '从首次验证到长期迭代，围绕你真正需要交付的工作流来构建。',
      services: [
...
const english = {
  ...
  paths: {
    ...
    teams: {
      kicker: '02 / FOR TEAMS',
      title: 'Make Nomi fit your business',
      description: 'From first validation to long-term iteration, built around the workflow you actually need to ship.',
      services: [
